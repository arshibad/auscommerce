...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        $path = dirname($this->get_server_var('SCRIPT_FILENAME')).'/files/';
        $pathUrl = $this->get_full_url().'/files/';
        $path  = str_replace("uploadimage/server/php/files/","images/",$path);
        $pathUrl = str_replace("uploadimage/server/php/files/","images/",$pathUrl);
        $this->options = array(
    ...
    protected function get_file_objects($iteration_method = 'get_file_object') {
        ...
        $var = array_values(array_filter(array_map(
