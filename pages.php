...
?>
  ...
  ?>
		...
		<?php }else{?>
			 <li class="element isotope-item match miss" data-large="img/gallery/<?php echo $productsArr[$i]['small_image']?>" id="<?php echo $productsArr[$i]['name'];?>" data-title="<?php echo $productsArr[$i]['name'];?>" data-added="29/05/2013" data-visits="4" style="list-style: none;">
				<div class="clientcontainer normal" style="z-index: 900;">
					<div class="clientcard hl">
						<div class="front face">
						  <img src="img/gallery/<?php echo $productsArr[$i]['small_image']?>">
